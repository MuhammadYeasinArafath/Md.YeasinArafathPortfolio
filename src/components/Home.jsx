    ...
    <section className="bg-light p-5 min-vh-100">
      <div className='container-fluid'>
       <div className='d-sm-flex align-items-center justify-content-between'>
          <div className='ms-sm-5 ps-sm-5 d-flex flex-column align-items-center align-items-lg-start'>
            <h1 className=''>Hi, I'm Md. Yeasin Arafath</h1>
            <h1 className='fw-bold custom-font textAnimation1..'>Web Developer.  </h1>
            <p className='pt-5  fw-bold textAnimation2..'>Front-End Development / ReactJS Developer / Programmer / CMS Developer(WordPress-Shopify).</p>
